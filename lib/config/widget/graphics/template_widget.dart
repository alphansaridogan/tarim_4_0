        ...
        RadialAxis(
            ...
            ranges: <GaugeRange>[
              GaugeRange(
                  ...
                  endWidth: 0.265,
                  color: Color.fromARGB(189, 155, 207, 125)),
              GaugeRange(
                  startValue: 0,
                  endValue: 10,
                  startWidth: 0.265,
                  sizeUnit: GaugeSizeUnit.factor,
                  endWidth: 0.265,
                  color: Color.fromARGB(189, 110, 207, 139)),
              GaugeRange(
                  startValue: 10,
                  endValue: 30,
                  startWidth: 0.265,
                  sizeUnit: GaugeSizeUnit.factor,
                  endWidth: 0.265,
                  color: Color.fromARGB(189, 56, 179, 132)),
              GaugeRange(
                  startValue: 30,
                  endValue: 40,
                  startWidth: 0.265,
                  sizeUnit: GaugeSizeUnit.factor,
                  endWidth: 0.265,
                  color: Color.fromARGB(189, 40, 156, 93)),
              GaugeRange(
                  startValue: 40,
                  endValue: 50,
                  startWidth: 0.265,
                  sizeUnit: GaugeSizeUnit.factor,
                  endWidth: 0.265,
                  color: Color.fromARGB(163, 19, 117, 51)),
              GaugeRange(
                  startValue: 50,
                  endValue: 60,
                  startWidth: 0.265,
                  sizeUnit: GaugeSizeUnit.factor,
                  endWidth: 0.265,
                  color: Color.fromARGB(162, 0, 65, 22)),
            ],
